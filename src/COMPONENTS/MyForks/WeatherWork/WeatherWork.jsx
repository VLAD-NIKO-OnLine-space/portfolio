...
const WeatherWork = () => {
    return (
        <div className={styles.main}>
            <img src="./WorkPic/weatherFon.jpg" className={styles.fon}/>
            <h1 className={styles.title}>4weather</h1>
            <img src='./WorkPic/weather1.png' className={styles.img1}/>
            <div className={styles.contentBlock}>
                <img src='./WorkPic/weather2.png' className={styles.img2}/>
