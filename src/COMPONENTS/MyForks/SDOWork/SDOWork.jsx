...
const SDOWork = () => {
    return (
        <div className={styles.main}>
            <img src="./WorkPic/sdoFon.jpg" className={styles.fonImg} />
            ...
            <div className={styles.picContainer}>
                <img src='./WorkPic/sdo1.png' className={styles.picLeft}/>
                <img src='./WorkPic/sdo2.png' className={styles.picCenter}/>
                <img src='./WorkPic/sdo3.png' className={styles.picRight}/>
            </div>
        </div>
    );
};
